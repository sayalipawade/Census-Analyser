...
{
    @Override
    public Map<String, StateCensusDAO> loadCensusData(String... filePath) throws CensusAnalyserException, CSVBuilderException {
    ...
    private Map<String,StateCensusDAO> loadStateCodeData(Map<String,StateCensusDAO> csvStateCensusMap, String filePath) throws CensusAnalyserException {
        try (Reader reader = Files.newBufferedReader(Paths.get(filePath));)
        {
            ICSVBuilder icsvBuilder = CSVBuliderFactory.createCSVBulider();
            Iterator<IndianStateCensusClass> csvStateCensusIterator = icsvBuilder.getCSVfile(reader,IndianStateCensusClass.class);
            ...
            StreamSupport.stream(stateCensusIterable.spliterator(), false)
                    ...
                    .forEach(csvStateCensusPojo -> csvStateCensusMap.get(csvStateCensusPojo.getState()).state = csvStateCensusPojo.getState());
        }
        catch (IOException e)
        {
